      ...
      <section class="content">
          ...
          <div class="row">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                  <a href="pengukuran_create.php" class="btn btn-block btn-primary"><i class="fas fa-plus"></i> Tambah</a></h3>
              </div>
		...
		?>
		  <tr>
		    ...
		    <td>
		      <a href="pengukuran_update.php?id=<?php echo $row['id'] ?>" class="btn btn-secondary btn-block">Edit</a>
		      <a href="pengukuran_delete.php?id=<?php echo $row['id'] ?>" onClick="return confirm('Apakah Anda benar-benar mau menghapusnya?')" class="btn btn-danger btn-block"><i class="fas fa-trash"></i> Hapus</a>
		    </td>
		  </tr>
		<?php
		  $no++;
